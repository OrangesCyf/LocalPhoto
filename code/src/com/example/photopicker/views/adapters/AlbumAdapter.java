	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = LayoutInflater.from(mContext).inflate(
					R.layout.lp_adapter_albumlist, parent, false);
			viewHolder.coverImageView = (ImageView) convertView
					.findViewById(R.id.album_item_cover);
			viewHolder.albumItemTitleView = (TextView) convertView
					.findViewById(R.id.album_item_title);
			viewHolder.albumItemCountView = (TextView) convertView
					.findViewById(R.id.album_item_count);
		...
		String displayItemUri = ThumbnailsUtil.MapgetHashValue(
				item.getImage_id(), item.getPath_file());
